...
ds4-agent: $(AGENT_BIN_OBJ) ds4_help.o ds4_web.o ds4_web_remote_cdp.o ds4_kvstore.o linenoise.o $(AGENT_BIN_CORE_OBJS)
	$(AGENT_BIN_LINK) -o $@ $(AGENT_BIN_OBJ) ds4_help.o ds4_web.o ds4_web_remote_cdp.o ds4_kvstore.o linenoise.o $(AGENT_BIN_CORE_OBJS) $(AGENT_BIN_LIBS)
...
ds4_agent_test_cpu.o: tests/ds4_agent_test.c ds4_agent.c ds4.h ds4_ssd.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_web.h linenoise.h
...
ds4_agent_test: $(AGENT_TEST_OBJ) ds4_help.o ds4_web.o ds4_web_remote_cdp.o ds4_kvstore.o linenoise.o $(AGENT_TEST_CORE_OBJS)
	$(AGENT_TEST_LINK) -o $@ $(AGENT_TEST_OBJ) ds4_help.o ds4_web.o ds4_web_remote_cdp.o ds4_kvstore.o linenoise.o $(AGENT_TEST_CORE_OBJS) $(AGENT_TEST_LIBS)
