...
cpu: ds4_cli_cpu.o ds4_server_cpu.o ds4_bench_cpu.o ds4_eval_cpu.o ds4_agent_cpu.o ds_agent_subagent_cpu.o ds4_help.o ds4_web.o ds4_web_remote_cdp.o ds4_kvstore.o linenoise.o rax.o $(CPU_CORE_OBJS)
	...
	$(CC) $(CFLAGS) -o ds4-agent ds4_agent_cpu.o ds_agent_subagent_cpu.o ds4_help.o ds4_web.o ds4_web_remote_cdp.o ds4_kvstore.o linenoise.o $(CPU_CORE_OBJS) $(LDLIBS)
...
ds4_agent.o: ds4_agent.c ds4_agent_internal.h ds_agent_subagent.h ds4.h ds4_ssd.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_web.h linenoise.h
	$(CC) $(CFLAGS) -c -o $@ ds4_agent.c

ds_agent_subagent.o: ds_agent_subagent.c ds4_agent_internal.h ds_agent_subagent.h ds4.h ds4_web.h
	$(CC) $(CFLAGS) -c -o $@ ds_agent_subagent.c
...
ds4_agent_test.o: tests/ds4_agent_test.c ds4_agent.c ds4_agent_internal.h ds_agent_subagent.h ds4.h ds4_ssd.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_web.h linenoise.h
	$(CC) $(CFLAGS) -Wno-unused-function -c -o $@ tests/ds4_agent_test.c

ds_agent_subagent_test.o: ds_agent_subagent.c ds4_agent_internal.h ds_agent_subagent.h ds4.h ds4_web.h
	$(CC) $(CFLAGS) -DDS4_AGENT_TEST -Wno-unused-function -c -o $@ ds_agent_subagent.c

ds4_agent_test_cpu.o: tests/ds4_agent_test.c ds4_agent.c ds4_agent_internal.h ds_agent_subagent.h ds4.h ds4_ssd.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_web.h linenoise.h
	$(CC) $(CFLAGS) -DDS4_NO_GPU -Wno-unused-function -c -o $@ tests/ds4_agent_test.c

ds_agent_subagent_test_cpu.o: ds_agent_subagent.c ds4_agent_internal.h ds_agent_subagent.h ds4.h ds4_web.h
	$(CC) $(CFLAGS) -DDS4_NO_GPU -DDS4_AGENT_TEST -Wno-unused-function -c -o $@ ds_agent_subagent.c
...
ds4_agent_cpu.o: ds4_agent.c ds4_agent_internal.h ds_agent_subagent.h ds4.h ds4_ssd.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_web.h linenoise.h
	$(CC) $(CFLAGS) -DDS4_NO_GPU -c -o $@ ds4_agent.c

ds_agent_subagent_cpu.o: ds_agent_subagent.c ds4_agent_internal.h ds_agent_subagent.h ds4.h ds4_web.h
	$(CC) $(CFLAGS) -DDS4_NO_GPU -c -o $@ ds_agent_subagent.c
